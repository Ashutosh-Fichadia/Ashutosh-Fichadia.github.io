                                                                     ...
                                                                     echo "<li class='active'>";
                                                                             echo "<div class='d-flex bd-highlight'>";
                                                                                     echo "<div class='img_cont'>";
                                                                                             echo "<img src='https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg' class='rounded-circle user_img'>";
                                                                                             echo "<span class='online_icon'></span>";
                                                                                     echo "</div>";
                                                                                     echo "<div class='user_info'>";
                                                                                             echo "<span><input type='submit' id='ubtn' name='mybtn' value=$unm></span>";
                                                                                             echo "<p>$unm is online</p>";
                                                                                     echo "</div>";
                                                                             echo "</div>";
                                                                     echo "</li>";
                                                             }
				...
				<div class="col-md-8 col-xl-6 chat">
                                        ...
                                        if($nm=="")
					{
							...
							echo "<div class='card-header msg_head'>";
									echo "<div class='d-flex bd-highlight'>";
									echo "</div>";
									echo "<span id='action_menu_btn'><i class='fas fa-ellipsis-v'></i></span>";
									echo "<div class='action_menu'>";
                                                                                echo "<ul>";
                                                                                        echo "<a href='welcome.php' id='a1'><li><i class='fa fa-home'></i> HOME</li></a>";
                                                                                        echo "<a href='mylogout.php' id='a2'><li><i class='fa fa-sign-out'></i> LOGOUT</li></a>";
                                                                                echo "</ul>";
                                                                        echo "</div>";
                                                        echo "</div>";
							echo "<div class='card-body msg_card_body'>";
                                                                echo "<div id='sym'><i class='fas fa-comments' style='color:white; font-size:200px; padding:50px 30px 20px 190px;'></i></div>";
                                                                echo "<h3 id='welmsg'>COME! LET'S CHAT</h3>";
							echo "</div>";							
                                                echo "</div>";
					}
                                        else
                                        {
                                                $nm1 = $unm.$_SESSION["uname"];
                                                $nm2 = $_SESSION["uname"].$unm;
                                                $cq = "select 1 from $nm1 LIMIT 1";
                                                $cq1 = "select 1 from $nm2 LIMIT 1";
                                                $c1 = mysqli_query($conn,$cq);
                                                $c2 = mysqli_query($conn,$cq1);
                                                ...
                                                echo "<div class='card'>";
                                                        echo "<div class='card-header msg_head'>";
                                                                echo "<div class='d-flex bd-highlight'>";
                                                                        ...
                                                                        echo "</div>";
                                                                        echo "<div class='user_info'>";
                                                                                echo "<span>Chat with $unm </span>";
                                                                                echo "<p>1767 Messages</p>";
                                                                        echo "</div>";
                                                                        echo "<div class='video_cam'>";
                                                                                echo "<span><i class='fas fa-video'></i></span>";
                                                                                echo "<span><i class='fas fa-phone'></i></span>";
                                                                        echo "</div>";
                                                                echo "</div>";
                                                                echo "<span id='action_menu_btn'><i class='fas fa-ellipsis-v'></i></span>";
                                                                echo "<div class='action_menu'>";
                                                                        echo "<ul>";
                                                                                echo "<li><i class='fas fa-user-circle'></i> View profile</li>";
                                                                                echo "<li><i class='fas fa-users'></i> Add to close friends</li>";
                                                                                echo "<li><i class='fas fa-plus'></i> Add to group</li>";
                                                                                echo "<li><i class='fas fa-ban'></i> Block</li>";
                                                                        echo "</ul>";
                                                                echo "</div>";
                                                        echo "</div>";
                                                        ...
                                                        while($row=mysqli_fetch_assoc($r1))
                                                        {
                                                                ...
                                                                else
                                                                {
                                                                        ...
                                                                        echo "<div class='d-flex justify-content-start mb-4'>";
                                                                                echo "<div class='img_cont_msg'>";
                                                                                        echo "<img src='https://static.turbosquid.com/Preview/001292/481/WV/_D.jpg' class='rounded-circle user_img_msg'>";
                                                                                echo "</div>";
                                                                                echo "<div class='msg_cotainer'>";              
                                                                                        echo "".$msg1;
                                                                                        echo "<span class='msg_time'>$t1, $d1</span>";  
                                                                                echo "</div>";
                                                                        echo "</div>";
